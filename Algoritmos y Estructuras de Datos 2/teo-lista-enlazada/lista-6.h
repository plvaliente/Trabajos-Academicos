...
//VERSION 6: cumple el test de eficiencia, manejando correctamente el constness. Pero, surge una duda de qué tenemos que hacer
//cuando el valor de retorno de una función puede ser const o no const. (to const or not to const?...that is the question)
//
